    ...
    return (
        <>
            <div className={`${props.pt}`}>
                <div className={`w-full ${props.bg} ${props.text} h-[664px] md:w-[327px] xl:w-[380px] py-[50px] px-10 space-y-[35px] place-items-center rounded hover:scale-105 duration-500 cursor-pointer`}>
