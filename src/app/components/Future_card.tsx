...
const Future_card = (props: any) => {
    return (
        <>
            <div className="w-full md:w-[328px] h-[606px] md:h-full hover:-translate-y-1 duration-500 ">
                <div className="w-full md:w-[348px] h-[300px] cursor-pointer">
                    <Image src={props.image} alt="Product" className="w-full h-full object-cover" />
                </div>
                <div className="h-[306px] md:h-full pt-[25px] pb-[35px] px-[25px] space-y-[16px]">
