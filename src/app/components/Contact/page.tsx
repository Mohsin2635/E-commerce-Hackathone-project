    ...
    <>
      ...
      <div className="w-full h-[1071px] md:h-full md:flex md:px-[12%] justify-between items-center">
        <div className="w-full h-[590px] md:h-[518px] py-6 md:py-3 space-y-5 md:space-y-2 place-items-center md:place-items-start overflow-hidden">
          ...
          <div className="w-[337px] h-[100px] md:h-[160px] py-6 text-[#252B42] text-2xl text-center md:text-start font-bold md:text-5xl ">
            Get in touch today!
          </div>
          ...
          <p className="w-[277px] h-[120px] md:w-[376px] md:h-[80px] text-center md:text-start text-xl text-[#737373]">
          ...
          <div className="w-[242px] h-[50px] p-[10px] space-x-[34px] flex">
            <Image src={logo1} alt="Twitter logo" className="hover:-translate-y-1 duration-300 cursor-pointer" />
            <Image src={logo2} alt="Facebook logo" className="hover:-translate-y-1 duration-300 cursor-pointer" />
            <Image src={logo3} alt="Vector logo" className="hover:-translate-y-1 duration-300 cursor-pointer" />
            <Image src={logo4} alt="LinkedIn logo" className="hover:-translate-y-1 duration-300 cursor-pointer" />
          </div>
        </div>
        <div className="w-full h-[440px] md:h-[650px] place-items-center md:place-items-start ">
          <Image src={None} alt="None" className="w-[620px] h-full object-fill" />
        </div>
      </div>
      {/* Cards */}
      <div className="w-full h-[1431px] md:h-full bg-[#FAFAFA] place-items-center md:px-[12%]">
        <div className="w-[330px] h-full md:w-full pt-[30px] py-[45px] space-y-[60px] place-items-center">
          ...
          <div className="w-full h-[1119px] md:h-full md:flex justify-between">
            <Contact_Card image={icon1} bg="bg-white" text="text-[#252B42]" pt="md:pt-8" btntext="text-[#23A6F0]" />
            <Contact_Card image={icon2} bg="bg-[#252B42]" text="text-white" />
            <Contact_Card image={icon3} bg="bg-white" text="text-[#252B42]" pt="md:pt-8" btntext="text-[#23A6F0]" />
          </div>
        </div>
      </div>
      <div className="w-full h-[440px] md:h-full place-items-center">
