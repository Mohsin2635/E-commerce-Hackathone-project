...
const Footer = () => {
    return (
        <>
            <div className="w-full h-[173px] md:h-[58px] bg-[#FAFAFA] py-10 pl-[74px] md:px-[12%] md:flex justify-between items-center">
            ...
            <div className="w-full h-[1071px] md:h-[272px] py-[70px] pl-[74px] space-y-[30px] md:space-y-0 md:px-[12%] md:flex justify-between items-center">
